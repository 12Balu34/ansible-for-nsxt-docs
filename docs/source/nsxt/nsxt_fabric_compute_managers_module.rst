:source: network/nsxt/nsxt_fabric_compute_managers.py

:orphan:

.. _nsxt_fabric_compute_managers_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Login credentials for the compute manager</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-origin_type"></div>
                    <b>origin_type</b>
                    <a class="ansibleOptionLink" href="#parameter-origin_type" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>Compute manager type like vCenter</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. hint::
    If you notice any issues in this documentation, you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/network/nsxt/nsxt_fabric_compute_managers.py?description=%23%23%23%23%23%20SUMMARY%0A%3C!---%20Your%20description%20here%20--%3E%0A%0A%0A%23%23%23%23%23%20ISSUE%20TYPE%0A-%20Docs%20Pull%20Request%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
