:source: nsxt/nsxt_manager_auto_deployment.py

:orphan:

.. _nsxt_manager_auto_deployment_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-deployment_requests"></div>
                    <b>deployment_requests</b>
                    <a class="ansibleOptionLink" href="#parameter-deployment_requests" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">array of ClusterNodeVMDeploymentRequest</span>
                                                 / <span style="color: red">required</span>                    </div>
                                    </td>
                                <td>
                                                                                                                                                            </td>
                                                                <td>
                                            <div>Cluster node VM deployment requests to be deployed by the Manager.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Unique node-id of a principal</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Unique node-name of a principal</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
