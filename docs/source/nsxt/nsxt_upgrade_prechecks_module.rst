:source: nsxt/nsxt_upgrade_prechecks.py

:orphan:

.. _nsxt_upgrade_prechecks_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>State can be either &#x27;present&#x27; or &#x27;absent&#x27;. &#x27;present&#x27; is used to run pre upgrade checks. &#x27;absent&#x27; is used to abort preupgrade checks.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Timeout while polling for prechecks to complete</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
