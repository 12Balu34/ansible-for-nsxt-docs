:source: nsxt/nsxt_ip_blocks.py

:orphan:

.. _nsxt_ip_blocks_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Represents network address and the prefix length which will be                 associated with a layer-2 broadcast domain</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Opaque identifier meaningful to the API user</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
